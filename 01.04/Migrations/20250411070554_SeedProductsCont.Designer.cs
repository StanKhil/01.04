...
namespace _01._04.Migrations
{
    ...
    [Migration("20250411070554_SeedProductsCont")]
    partial class SeedProductsCont
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_01._04.Data.Entities.ItemImage", b =>
                {
            ...
            modelBuilder.Entity("_01._04.Data.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_01._04.Data.Entities.ProductGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_01._04.Data.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_01._04.Data.Entities.UserAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("_01._04.Data.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("_01._04.Data.Entities.ItemImage", b =>
                {
                    b.HasOne("_01._04.Data.Entities.Product", null)
                        .WithMany("Images")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_01._04.Data.Entities.ProductGroup", null)
                        .WithMany("Images")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("_01._04.Data.Entities.Product", b =>
                {
                    b.HasOne("_01._04.Data.Entities.ProductGroup", "ProductGroup")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("_01._04.Data.Entities.ProductGroup", b =>
                {
                    b.HasOne("_01._04.Data.Entities.ProductGroup", "ParentGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("_01._04.Data.Entities.UserAccess", b =>
                {
                    b.HasOne("_01._04.Data.Entities.UserRole", "UserRole")
                        .WithMany("UserAccesses")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_01._04.Data.Entities.User", "User")
                        .WithMany("userAccesses")
